      ...
      <div className="WorldTycoonCont">
        <div className="descripCont">
          ...
          <div className="ParaCont">
            ...
            <p>
              World Tycoon is a real-time multiplayer strategic board game for
              up to four players, where global dominance is achieved through
              smart investments and calculated decisions. Players travel across
              a world map of country-based properties, acquiring assets, paying
              rent, and managing resources through dice-driven turns.
            </p>
            <p>
              The game features synchronized real-time turns, centralized
              banking, and persistent state management, ensuring every action is
              instantly reflected for all players. With high-stakes financial
              strategy and competitive gameplay, World Tycoon challenges players
              to build an empire—or risk economic collapse.
            </p>
          </div>
        </div>
        <div className="FeatureCont">
          ...
          <div className="FeatCard">
            <div className="FeatCont">
              ...
              <p>
                Play with up to four players in a synchronized,
                server-controlled environment.
              </p>
            </div>
            <div className="FeatCont">
